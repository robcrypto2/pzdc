...
RESOURCES += src/qt/pzdc.qrc src/qt/pzdc_locale.qrc

TRANSLATIONS += src/qt/locale/pzdc_bg.ts \
                src/qt/locale/pzdc_de.ts \
                src/qt/locale/pzdc_en.ts \
                src/qt/locale/pzdc_es.ts \
                src/qt/locale/pzdc_fi.ts \
                src/qt/locale/pzdc_fr.ts \
                src/qt/locale/pzdc_it.ts \
                src/qt/locale/pzdc_ja.ts \
                src/qt/locale/pzdc_pl.ts \
                src/qt/locale/pzdc_pt.ts \
                src/qt/locale/pzdc_ru.ts \
                src/qt/locale/pzdc_sk.ts \
                src/qt/locale/pzdc_sv.ts \
                src/qt/locale/pzdc_vi.ts \
                src/qt/locale/pzdc_zh_CN.ts \
                src/qt/locale/pzdc_zh_TW.ts
