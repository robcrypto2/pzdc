...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Pzdc Core pzdc-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  pzdc-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pzdc transaction") + "\n" +
                               "  pzdc-tx [options] -create [commands]   " + _("Create hex-encoded pzdc transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded pzdc transaction
