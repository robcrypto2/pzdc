...
git clone https://github.com/pzdc-crypto/pzdc.git
cd pzdc
...
```bash
    ...
    From https://github.com/pzdc-crypto/pzdc
...
For example:
```bash
URL=https://github.com/crowning-/pzdc.git
...
[pzdc/gitian.sigs](https://github.com/pzdc-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
