...
This mechanism has been integrated into Bitcore-Node-PZDC which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/PZDC-Project/insight-api-pzdc#web-socket-api](https://github.com/PZDC-Project/insight-api-pzdc#web-socket-api) 
* API: [https://github.com/PZDC-Project/insight-api-pzdc#swifttx-transactions](https://github.com/PZDC-Project/insight-api-pzdc#swifttx-transactions) 
...
By default, the PZDC Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the PZDC Core daemon:
