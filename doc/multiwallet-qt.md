...
In order to support loading of multiple wallets in pzdc-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is pzdc.cpp.
...
Changes to pzdc.cpp
----------------------
pzdc.cpp is the entry point into pzdc-qt, and as such, will require some minor modifications to provide hooks for
