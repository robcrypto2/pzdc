Contributing to PZDC Core
============================

The PZDC Core project operates an open contributor model where anyone is
...
The following applies to code changes to the PZDC Core project, and is not to be
confused with overall PZDC Network Protocol consensus changes.

Whether a pull request is merged into PZDC Core rests with the project merge
...
Patches that change PZDC consensus rules are considerably more involved than
...
Where a patch set proposes to change the PZDC consensus, it must have been
...
The project leader is the release manager for each PZDC Core release.
